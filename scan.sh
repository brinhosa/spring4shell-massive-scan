...
do
        ...
        echo $status_code , $url "?class.module.classLoader.URLs%5B0%5D=0"
        if [ $status_code == "400" ]
        then
        ...
        echo $status_code , $url "?class.module.classLoader.DefaultAssertionStatus=test"
        if [ $status_code == "400" ]
        then
                echo "[ ++ ] Vulnerable enviroment: $url"
        fi        
        ...
        echo $status_code , $url "/actuator/info?class.module.classLoader.URLs%5B0%5D=0"
        if [ $status_code == "400" ]
        then
        ...
        echo $status_code , $url "/system/mappings?class.module.classLoader.URLs%5B0%5D=0"
        if [ $status_code == "400" ]
        then
        ...
        echo $status_code , $url "/system/showOsInfo"
        if [ $status_code == "400" ]
        then
        ...
        echo $status_code , $url "/actuator/health"
        if [ $status_code == "400" ]
        then
        ...
        echo $status_code , $url "/peripheral/v2/api-docs?class.module.classLoader.URLs%5B0%5D=0" 
        if [ $status_code == "400" ]
        then
