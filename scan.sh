...
do
        ...
        echo $status_code , $url , 1 , GET , "$url?class.module.classLoader.URLs%5B0%5D=0"
        if [ $status_code == "400" ]
        then
        ...
        echo $status_code , $url , 2, GET , "$url?class.module.classLoader.DefaultAssertionStatus=test"
        if [ $status_code == "400" ]
        then
                echo "[ ++ ] Vulnerable enviroment: $url"
        fi        
        status_code=$(curl -k -L -s --data "class.module.classLoader.URLs%5B0%5D=0" -o /dev/null -w "%{http_code}" "$url" )
        echo $status_code , $url , 3 , POST , --data "class.module.classLoader.URLs%5B0%5D=0"
        if [ $status_code == "400" ]
        then
        ...
        echo $status_code , $url , 4 , GET , "$url/actuator/info?class.module.classLoader.URLs%5B0%5D=0"
        if [ $status_code == "400" ]
        then
        ...
        echo $status_code , $url , 5 , GET , "$url/system/mappings?class.module.classLoader.URLs%5B0%5D=0"
        if [ $status_code == "400" ]
        then
        ...
        echo $status_code , $url , 6 , POST , --data "class.module.classLoader.URLs%5B0%5D=0" , "$url/system/showOsInfo"
        if [ $status_code == "400" ]
        then
        ...
        echo $status_code , $url , 7 , POST , --data "class.module.classLoader.URLs%5B0%5D=0" , "$url/actuator/health"
        if [ $status_code == "400" ]
        then
        ...
        echo $status_code , $url , 8 , GET , "$url/peripheral/v2/api-docs?class.module.classLoader.URLs%5B0%5D=0"
        if [ $status_code == "400" ]
        then
